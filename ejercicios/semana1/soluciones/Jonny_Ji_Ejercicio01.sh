...
[+] ¡Se instalo la versión v25.0, para crear billeteras Legacy y poder extraer la privkey!
[+]	"1. Para comenzar crea dos carteras nuevas usando los comandos para billeteras legacy"
...
[+]	"2. Genera una dirección en la billetera Miner con etiqueta "Recompensa de Minería" "
[+]	    "$ bitcoin-cli -rpcwallet=Miner getnewaddress "Recompensa de Mineria"
[+]	"3. Extraer nuevos bloques depositando la recompensa a esta dirección"
[+]	"Para obtener un saldo de billetera positivo se utiliza el comando 'generatetoaddress' "
[+]	"El siguiente comando genera un bloque (o varios) y lo envia a la direccion"
[+]	    "$ bitcoin-cli generatetoaddress 1 "direccion-recompensa" "
[+]	"El siguiente comando es para visualizar el saldo en la cartera"
[+]	    "$ bitcoin-cli -rpcwallet=Miner getbalance "
[+] "Podemos identificar los UTXO que tenemos disponibles con el siguiente comando"
[+]     "$ bitcoin-cli -rpcwallet=Miner listunspent "
[+] "En pantalla vemos detalles como "txid", "vout", "address", "label", "scripttpubkey", "amount", "confirmations" "
[+] "4. Crear una dirección receptora con la etiqueta "Recibido" desde la billetera Trader "
[+] "5. Enviar una transacción que pague 20 BTC desde la billetera Miner a la billetera Trader "
[+]     "$ bitcoin-cli -rpcwallet=Miner sendtoaddress <<address_Recibido>> 20.000 "
[+] "6. Obtener la transacción no confirmada desde el "mempool" del nodo y mostrar el resultado"
[+]     "$ bitcoin-cli getmempoolentry <<Txid>> "
[+] "7. Generar una nueva dirección para generar el nuevo bloque "
[+]     "$ bitcoin-cli -rpcwallet=Miner getnewaddress "
[+] "8. Confirmar la transacción creando 1 bloque adicional "
[+]     "$ bitcoin-cli generatetoaddress 1 <<new_address_Miner>> "
[+] "9. Obtener los siguientes detalles de la transacción y mostrarlos en la terminal: "
[+]     "$ bitcoin-cli -rpcwallet=Miner gettransaction <<TxId_transacción_20BTC>> "
[+] "10. Verificando el balance de la wallet trader "
[+]     "$ bitcoin-cli -rpcwallet=Trader listunspent "
[+]	"Si tienes dudas de cualquier comando ejecuta '$ bitcoin-cli help' "
[+]	¡Puedes copiar estas instrucciones para que te sirvan de guía!
